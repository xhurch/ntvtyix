...
// Modified for Xhurch NTVTY to show/hide objects for different years
//
//=============================================================================
...
//-------------------------------------------------------------------------
public class XhurchTeleportPoint : TeleportMarkerBase
{
...
#if UNITY_EDITOR
	//-------------------------------------------------------------------------
	[CustomEditor( typeof( XhurchTeleportPoint ) )]
	public class TeleportPointEditor : Editor
	{
		...
		void OnEnable()
		{
			...
			{
				XhurchTeleportPoint teleportPoint = Selection.activeTransform.GetComponent<XhurchTeleportPoint>();
