...
//-------------------------------------------------------------------------
public class XhurchTeleport : MonoBehaviour
{
    ...
    private XhurchTeleportPoint[] teleportMarkers;
    private XhurchTeleportPoint pointedAtTeleportMarker;
    private XhurchTeleportPoint teleportingToMarker;
    ...
    public static SteamVR_Events.Event<XhurchTeleportPoint> Player = new SteamVR_Events.Event<XhurchTeleportPoint>();
    public static SteamVR_Events.Action<XhurchTeleportPoint> PlayerAction(UnityAction<XhurchTeleportPoint> action) { return new SteamVR_Events.Action<XhurchTeleportPoint>(Player, action); }

    public static SteamVR_Events.Event<XhurchTeleportPoint> PlayerPre = new SteamVR_Events.Event<XhurchTeleportPoint>();
    public static SteamVR_Events.Action<XhurchTeleportPoint> PlayerPreAction(UnityAction<XhurchTeleportPoint> action) { return new SteamVR_Events.Action<XhurchTeleportPoint>(PlayerPre, action); }

    //-------------------------------------------------
    private static XhurchTeleport _instance;
    public static XhurchTeleport instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = GameObject.FindObjectOfType<XhurchTeleport>();
            }
    ...
    void Start()
    {
        teleportMarkers = GameObject.FindObjectsOfType<XhurchTeleportPoint>();
        ...
        if (player == null)
        {
            Debug.LogError("<b>[SteamVR Interaction]</b> XhurchTeleport: No Player instance found in map.", this);
    ...
    {
        foreach (XhurchTeleportPoint teleportMarker in teleportMarkers)
        {
            XhurchTeleportPoint teleportPoint = teleportMarker as XhurchTeleportPoint;
    ...
    private void UpdatePointer()
    {
        ...
        XhurchTeleportPoint hitTeleportMarker = null;
        ...
        {
            hitSomething = true;
            hitTeleportMarker = hitInfo.collider.GetComponentInParent<XhurchTeleportPoint>();
        }
    ...
    private void InitiateTeleportFade()
    {
        ...
        XhurchTeleportPoint teleportPoint = teleportingToMarker as XhurchTeleportPoint;
        if (teleportPoint != null && teleportPoint.teleportType == XhurchTeleportPoint.TeleportPointType.SwitchToNewScene)
        {
    ...
    //-------------------------------------------------
    private void HighlightSelected(XhurchTeleportPoint hitTeleportMarker)
    {
